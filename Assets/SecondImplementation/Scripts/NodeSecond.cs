...
{
    public class NodeSecond : NetworkBehaviour
    {
        CSVReader csvReader;
        Route route;
        Renderer ren;
        ...
        public NetworkVariable<DataStruct_Cards.NetworkNodeData> currentNodeData = new NetworkVariable<DataStruct_Cards.NetworkNodeData>();
        ...
        public void SettingCurrentNode()
        {
            foreach (CSVReader.NodeData nodeData in csvReader.nodeDataArray)
            {
                if (nodeData.nodeNumber == currentNodeNumber)
                {
                    ...
                    currentNodeData.Value = new DataStruct_Cards.NetworkNodeData { };
